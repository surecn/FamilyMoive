...
public class IjkSubtitleEngine implements SubtitleEngine {
    private static final String TAG = IjkSubtitleEngine.class.getSimpleName();
    ...
    public IjkSubtitleEngine(final IMediaPlayer mediaPlayer) {
