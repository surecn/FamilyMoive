...
import com.surecn.familymovie.common.samba.IConfig;
...
public class DialogUtil {
    ...
    public final static void showInputAccoutDialog(final Context context, final IConfig.OnConfigListener listener) {
        //-------------------
        int paddingTop = (int) (context.getResources().getDisplayMetrics().density * 50);
        int padding = (int) (context.getResources().getDisplayMetrics().density * 20);
        LinearLayout ll = new LinearLayout(context);
