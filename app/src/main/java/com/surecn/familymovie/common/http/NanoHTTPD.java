package com.surecn.familymovie.common.http;
 ...
 * <li>File server supports simple skipping for files (continue load)</li>
...
public abstract class NanoHTTPD {
	...
	private NanoHTTPDListener mNanoHTTPDListener;
	...
	public void setNanoHTTPDListener(NanoHTTPDListener mNanoHTTPDListener) {
		this.mNanoHTTPDListener = mNanoHTTPDListener;
	}
...
//									}
				...
				if (mNanoHTTPDListener != null && !mStop) {
					closeAllConnections();
					mNanoHTTPDListener.onServerError();
				}
			}
		});
